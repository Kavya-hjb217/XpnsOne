...
export default function Home() {
  ...
  <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
    <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
      <Badge variant="outline" className="bg-green-100 text-green-700">
       ...
       <h1 className=" gradient-title mx-auto max-w-4xl text-3xl font-bold md:text-7xl">
    ...
    <div className="container mx-auto max-w-5xl overflow-hidden  shadow-sm">
  ...
  <section id="features" className="bg-gray-50 py-20">
    ...
    <h2 className="gradient-title mt-2 text-3xl md:text-4xl">
     One Stop Solution for All Your Expense Splitting Needs
    </h2>
    <p className="mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed">
      Discover a range of features designed to make expense splitting
  ...
  <section id="how-it-works" className="bg-gray-50 py-20">
    ...
    <h2 className="gradient-title mt-2 text-3xl md:text-4xl">
    Reduced Transactions...Faster Settlements
    </h2>
    <p className="mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed">
      Follow these simple steps to manage and split expenses with ease.
    </p>
...
© {new Date().getFullYear()} Kavya Barodia. All rights reserved.
</footer>
