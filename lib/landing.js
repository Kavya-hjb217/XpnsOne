...
{
  quote:
    "Running a restaurant means dealing with group payments all the time. With XpnsOne, I don’t have to worry about who owes what—it sorts everything out in seconds.",
  name: "Himanshu Barodia",
  image: "/testimonials/Himanshu-Barodia.png",
  role: "Restaurant Owner",
},
{
  quote:
    "As a teacher, I’m good with numbers, but tracking shared expenses with friends used to be a headache. XpnsOne just does it for me, and it’s always spot on.",
  name: "Sudhir Kumar",
  image: "/testimonials/Sudhir-Kumar.png",
  role: "Teacher",
},
{
  quote:
    "In college, splitting bills with friends always led to arguments. XpnsOne makes it crystal clear who paid what, so no one can get away with skipping their share.",
  name: "Yash Singh Naruka",
  image: "/testimonials/Yash-Singh-Naruka.png",
  role: "Law Student",
},
