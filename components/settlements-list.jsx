  ...
  return (
     <div className="flex flex-col gap-4">
      {settlements.map((settlement) => {
        const payer = getUserDetails(settlement.paidByUserId, userLookupMap, currentUser);
        const receiver = getUserDetails(settlement.receivedByUserId, userLookupMap, currentUser);
